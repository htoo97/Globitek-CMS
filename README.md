...
<img src='http://i.imgur.com/urT7QiJ.gifv' title='Video Walkthrough' width='' alt='Video Walkthrough' />
...
The syntax of SQL is totally new to me, so that required some reading. The whole concept of sanitizing HTML output data was also an unfamiliar one, so I learned a lot.
